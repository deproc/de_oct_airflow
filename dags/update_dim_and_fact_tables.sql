CREATE OR REPLACE TEMPORARY TABLE "ETL_AF"."DEV_DB"."TEMP" AS
SELECT
    sym.id AS symbol_id
    ,c.id AS company_id
    ,s.date
...
MERGE "ETL_AF"."DEV_DB"."FACT_STOCK_GROUP1" t
USING "ETL_AF"."DEV_DB"."TEMP" s
...
CREATE OR REPLACE TABLE "ETL_AF"."DEV_DB"."DIM_STOCK_GROUP1" as
SELECT * FROM "US_STOCKS_DAILY"."PUBLIC"."COMPANY_PROFILE";

CREATE OR REPLACE TABLE "ETL_AF"."DEV_DB"."DIM2_STOCK_GROUP1" as
