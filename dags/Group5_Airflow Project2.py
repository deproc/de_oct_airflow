...
SQL_INSERT_TO_FACT = f'INSERT INTO "ETL_AF"."DEV_DB"."FACT_STOCK_HISTORY_GROUP5" SELECT C.ID, S.DATE,\
S.OPEN, S.HIGH, S.LOW, S.CLOSE, S.VOLUME, S.ADJCLOSE FROM "US_STOCKS_DAILY"."PUBLIC"."STOCK_HISTORY" s' +
