...
SNOWFLAKE_STOCK_HISTORY = 'US_STOCKS_DAILY.PUBLIC.STOCK_HISTORY'
SNOWFLAKE_COMPANY_PROFILE = 'US_STOCKS_DAILY.PUBLIC.COMPANY_PROFILE'
...
WHERE DATE = DATEDIFF(DAY, 3, DATEDIFF(MONTH, -1, CURRENT_DATE()));
'''
# SQL updating DIM table commands
SQL_UPDATE_COMPANY_PROFILE = f"CREATE OR REPLACE TABLE {SNOWFLAKE_DIM_TABLE} AS SELECT * FROM {SNOWFLAKE_COMPANY_PROFILE};"
