...
CREATE_TABLE_SQL_STRING = (
    f"CREATE OR REPLACE TEMPORARY TABLE {SNOWFLAKE_SAMPLE_TABLE} (INVOICENO NUMBER(38,0), STOCKCODE VARCHAR(36), DESCRIPTION VARCHAR(100), 
    QUANTITY NUMBER(38,0), INVOICEDATE TIMESTAMP NTZ(9), MONTH NUMBER(2,0), DAY NUMBER(2,0), UNITPRICE NUMBER(10,0), CUSTOMERID NUMBER(38,0),
